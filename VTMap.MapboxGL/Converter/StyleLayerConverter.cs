...
namespace VTMap.MapboxGL.Converter
{
            ...
            if (paint.FillPattern != null)
            {
                ...
                if (paint.FillPattern.Stops == null && !paint.FillPattern.SingleVal.Contains("{"))
                {
                    area.SetVariableShader((context) =>
                    {
                        ...
                        if (sprite != null && sprite.Image != null)
                        {
                            return sprite.Image.ToShader(SKShaderTileMode.Repeat, SKShaderTileMode.Repeat, SKMatrix.CreateScale(context.Scale, context.Scale));
                        }
                        else
                        {
