...
using VTMap.MapboxGL.Converter;
using VTMap.MapboxGL.Json;
    ...
    public static class MGLStyleLoader
    {
        ...
        public static MGLStyleFile Load(Stream input, Assembly assemblyToUse)
        {
            ...
            var mglStyleFile = new MGLStyleFile(jsonStyle.Name, jsonStyle.Version)
            {
                ...
                Center = jsonStyle.Center != null ? new GeoPoint(jsonStyle.Center[0], jsonStyle.Center[1]) : new GeoPoint(0, 0)
            };
        ...
        private static IDrawableTileSource CreateVectorTileSource(JsonStyleFile jsonStyle, string name, JsonSource source, MGLSpriteAtlas spriteAtlas)
        {
            ...
            if (vectorTileSource != null)
            {
                ...
                if (vectorTileSource.MinZoom > maxMinZoom)
                    vectorTileSource.MinZoom = maxMinZoom;
            }
