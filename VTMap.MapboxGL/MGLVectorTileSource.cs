...
namespace VTMap.MapboxGL
{
    public class MGLVectorTileSource : IDrawableTileSource
    {
        ...
        {
            minZoomLevelProvider = source.Schema.Resolutions.First<KeyValuePair<int, Resolution>>().Value.UnitsPerPixel.ToZoomLevel();
            maxZoomLevelProvider = source.Schema.Resolutions.Last<KeyValuePair<int, Resolution>>().Value.UnitsPerPixel.ToZoomLevel();
            ...
            MaxZoom = 30; // (int)maxZoomLevelProvider;
            MinZoom = 0; // (int)minZoomLevelProvider;
        ...
        public Drawable GetDrawableTile(TileInfo ti)
        {
        ...
        private void UpdateResolutions()
        {
            ...
            for (int i = MinZoom; i <= MaxZoom; i++)
                Schema.Resolutions.Add(i, new Resolution(i, i.ToResolution()));
        }
